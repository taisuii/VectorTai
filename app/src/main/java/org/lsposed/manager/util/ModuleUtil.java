...
public final class ModuleUtil {
    ...
    public static boolean isLegacyModule(ApplicationInfo info) {
        return info.metaData != null && info.metaData.containsKey("rt.min.version");
    }
    ...
    public class InstalledModule {
        ...
        private InstalledModule(PackageInfo pkg, ZipFile modernModuleApk) {
            ...
            if (legacy) {
                Object minVersionRaw = app.metaData.get("rt.min.version");
        ...
        public List<String> getScopeList() {
            ...
            if (list != null) {
                ...
                //https://github.com/rovo89/TsBridge/commit/6b49688c929a7768f3113b4c65b429c7a7032afa
                list.replaceAll(s ->
                    switch (s) {
                        case "android" -> "system";
                        case "system" -> "android";
